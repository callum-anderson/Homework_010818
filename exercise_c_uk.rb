...
p "Capital of #{united_kingdom[1][:name]} changed to #{united_kingdom[1][:capital]}"
...
"Hash added for #{united_kingdom[3][:name]}."
...
p "The population of the UK is #{uk_population} (#{(uk_population/10**6)}m)."
